...
const gettingStartedSteps = [
  {
    ...
    description: "Get CloudSave from the App Store or Google Play Store",
    icon: Smartphone,
  },
  {
    step: "2",
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Master <span className="gradient-text">CloudSave</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to know about using CloudSave, creating channels,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card variant="bordered" className="md:col-span-2 bg-gradient-to-br from-success/10 to-success/5 border-success/20">
                <CardContent className="p-6 md:p-8">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Access your earnings and request payouts directly from your Profile page. CloudSave offers
