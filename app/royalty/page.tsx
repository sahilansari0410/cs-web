        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-6 sm:mb-8">
              Refer users to 100X and earn up to 25% royalty every month for life.
          ...
          >
            <Card variant="bordered" className="relative overflow-hidden">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Open the 100X app and grab your unique referral link and referral code
            ...
            <Card variant="bordered" className="relative overflow-hidden">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  When your referred user subscribes to 100X Premium at $49.99/month,
            ...
            <Card variant="bordered" className="relative overflow-hidden">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Royalty is instantly credited to your Creator Payout page in 100X
          ...
          >
              ...
              <CardContent className="p-6 md:p-8 relative">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Share your unique referral link or referral code from the 100X app. When a new user
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-start gap-2.5 p-3 rounded-lg bg-primary/10">
                      <CheckCircle2 className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                      <p className="text-sm text-foreground">Link found in the 100X app Referral section</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card variant="bordered" className="md:col-span-2 lg:col-span-2">
              <CardContent className="p-6 md:p-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Due to 100X&apos;s zero-knowledge encryption and privacy commitment, you cannot
            ...
            <Card variant="bordered" className="md:col-span-2 lg:col-span-2 bg-gradient-to-br from-orange-500/10 to-orange-500/5 border-orange-500/20 overflow-hidden">
              <CardContent className="p-6 md:p-8 relative">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-4">
                    When your referred user creates a channel on 100X and starts earning
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm text-muted-foreground">Your referred user creates a channel on 100X</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-7 h-7 rounded-full bg-amber-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <section className="py-10 sm:py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              See why 100X&apos;s Royalty Program stands out
            </p>
          </motion.div>
                    ...
                    <thead>
                      <tr className="border-b border-border">
                        ...
                        <th className="p-4 text-center">
                          <span className="gradient-text font-bold">100X</span>
                        </th>
            ...
            <Card variant="bordered" className="bg-gradient-to-r from-primary/10 via-purple-500/10 to-secondary/10 border-primary/20 overflow-hidden relative">
              ...
              <CardContent className="p-5 sm:p-8 md:p-12 relative z-10 text-center">
                ...
                <p className="text-sm sm:text-base text-muted-foreground max-w-xl mx-auto mb-6 sm:mb-8">
                  Join the 100X Royalty Program and turn every referral into a
