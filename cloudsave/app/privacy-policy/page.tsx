        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Your privacy is fundamental to everything we do at CloudSave. This policy explains how we protect your data.
            </p>
          ...
          >
            ...
            <Card variant="bordered" id="introduction">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <p>
                    This Privacy Policy (&quot;Policy&quot;) describes how AXSA Technologies Private Limited, operating as &quot;CloudSave&quot; (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), collects, uses, processes, shares, and protects your personal information when you use our services.
                  </p>
                  <p>This Policy applies to:</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li>The CloudSave mobile application (iOS and Android)</li>
                    <li>The CloudSave website (cloudsave.org and related domains)</li>
                    <li>CloudSave API and developer services</li>
                ...
                <div className="text-muted-foreground space-y-6">
                  ...
                  <div className="p-4 rounded-xl bg-success/10 border border-success/20">
                    ...
                    <ul className="list-disc pl-6 space-y-1 mb-4">
                      ...
                      <li>CloudSave employees, engineers, contractors, and automated systems cannot view, read, or access the contents of your encrypted files</li>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>CloudSave uses distributed infrastructure for security and reliability. Your encrypted files are:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                  ...
                  <div>
                    ...
                    <p>By using CloudSave, you acknowledge and agree that:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-6">
                  <div>
                    ...
                    <p className="mt-3">To exercise these rights, contact us at privacy@cloudsave.org or use the in-app settings.</p>
                  ...
                  <div>
                    ...
                    <div className="mt-3 p-3 rounded-lg bg-muted/50">
                      ...
                      <p>Email: grievance@cloudsave.org</p>
                  ...
                  <div>
                    ...
                    <p>We respect privacy rights in all jurisdictions where we operate. If your jurisdiction provides additional rights not listed above, please contact us at privacy@cloudsave.org, and we will address your request in accordance with applicable law.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card variant="bordered" id="children" className="bg-destructive/5 border-destructive/20">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <p><strong className="text-foreground">CloudSave is not intended for children.</strong></p>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Contact us immediately at privacy@cloudsave.org</li>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-muted/50">
                    ...
                    <p className="font-medium text-foreground">CloudSave Privacy Team</p>
                    <p>AXSA Technologies Private Limited</p>
                    <div className="mt-3">
                      <p>Email: privacy@cloudsave.org</p>
