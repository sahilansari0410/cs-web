                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">You must be at least 18 years old to use CloudSave.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          >
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>These Terms of Service (&quot;Terms&quot; or &quot;Agreement&quot;) constitute a legally binding contract between you (&quot;User,&quot; &quot;you,&quot; or &quot;your&quot;) and AXSA Technologies Private Limited, a company incorporated under the laws of India, operating as &quot;CloudSave&quot; (&quot;CloudSave,&quot; &quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).</p>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>The CloudSave mobile application (iOS and Android)</li>
                      <li>The CloudSave website and web application</li>
                      <li>CloudSave API and developer tools</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>Creating a CloudSave account</li>
                      <li>Downloading or installing the CloudSave application</li>
                      <li>Accessing or using any CloudSave Services</li>
            ...
            <Card variant="bordered" id="definitions">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-3">
                  <p><strong className="text-foreground">&quot;Account&quot;</strong> means your registered CloudSave user account.</p>
                  ...
                  <p><strong className="text-foreground">&quot;Cloud Coins&quot;</strong> means the virtual currency used within CloudSave Services.</p>
                  ...
                  <p><strong className="text-foreground">&quot;Encrypted Content&quot;</strong> means Content that is encrypted using CloudSave&apos;s zero-knowledge encryption system.</p>
                  ...
                  <p><strong className="text-foreground">&quot;Premium Plan&quot;</strong> means any paid subscription tier of CloudSave Services.</p>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>You must be at least 18 years old to use CloudSave. By using the Services, you represent and warrant that you meet this age requirement.</p>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>To access most features of CloudSave, you must create an account by providing a valid email address, a secure password, your name, and any other required information. You may also register using third-party authentication providers (such as Google or Apple Sign-In).</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>CloudSave provides cloud storage services allowing you to upload, store, and organize files, access your files from multiple devices, share files and folders with others, and encrypt your private files using zero-knowledge encryption.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-success/10 border border-success/20">
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      ...
                      <li>CloudSave does not have access to your encryption keys</li>
                  ...
                  <div>
                    ...
                    <p>CloudSave offers social features including creating and managing Channels, subscribing to and unlocking Channel content, and discovering content from other users.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">5.4 Cloud Coins Economy</h3>
                    <p>CloudSave operates a virtual currency system where you can earn Cloud Coins through various activities, use Cloud Coins to unlock Channels and premium features, and purchase Cloud Coins through in-app purchases.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>CloudSave offers a free plan that includes up to 1 TB of storage, basic features as described in our documentation, and an advertisement-supported experience.</p>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>Cloud Coins are a virtual currency for use within CloudSave Services:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>Revenue is calculated based on the &quot;15-Unlock Rule&quot;: An &quot;Active Subscriber&quot; is a user with 15 or more unlocks of your Channel per month. Revenue is calculated based on Active Subscribers only. CloudSave&apos;s records regarding subscriber activity are final and binding for revenue calculations.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">9.4 Revenue Share</h3>
                    <p>The revenue share percentage is specified in your Creator agreement. CloudSave reserves the right to modify the revenue share with 30 days notice.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>You are responsible for providing accurate tax information, paying all applicable taxes on your earnings, and complying with tax reporting requirements in your jurisdiction. CloudSave may be required to withhold taxes or report earnings to tax authorities.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">9.7 Program Termination</h3>
                    <p>We may suspend or terminate your participation if you violate these Terms or program policies, engage in fraudulent activity, fail to maintain eligibility requirements, or request termination. Upon termination, you will receive any earned but unpaid revenue, less any amounts owed to CloudSave.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li><strong className="text-foreground">iOS:</strong> Settings &gt; [Your Name] &gt; Subscriptions &gt; CloudSave &gt; Cancel Subscription</li>
                      <li><strong className="text-foreground">Android:</strong> Google Play Store &gt; Menu &gt; Subscriptions &gt; CloudSave &gt; Cancel Subscription</li>
                      <li><strong className="text-foreground">Web:</strong> CloudSave Settings &gt; Subscription &gt; Cancel</li>
                    </ul>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-warning/10 border border-warning/20">
                    ...
                    <p className="mt-2">CloudSave does not provide refunds for any premium subscription purchases, Cloud Coin purchases, or any other paid services. By making a purchase, you acknowledge and agree that all sales are final.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-success/10 border border-success/20">
                    <h3 className="font-semibold text-foreground mb-2">11.2 Try Before You Buy</h3>
                    <p>CloudSave provides a generous <strong className="text-foreground">free tier with 1 TB of storage</strong> that allows you to fully experience our service before making any purchase decision.</p>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      ...
                      <li>Ensure CloudSave meets your needs before purchasing premium</li>
                      <li>Contact our support team with any questions before upgrading</li>
                    </ul>
                    <p className="mt-2">Since we provide free access to our core services, you have ample opportunity to evaluate CloudSave before committing to a paid subscription. This is why we maintain a strict no-refund policy.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">11.3 App Store Purchases</h3>
                    <p>For purchases made through Apple App Store or Google Play Store, CloudSave does not process refunds. Any refund requests must be directed to the respective app store and are subject to their policies:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>Apple: https://support.apple.com/en-us/HT204084</li>
                      <li>Google: https://support.google.com/googleplay/answer/2479637</li>
                    </ul>
                    <p className="mt-2 text-sm">Note: CloudSave does not control or guarantee refunds through third-party app stores.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>To report violations, contact abuse@cloudsave.org or use the in-app &quot;Report&quot; feature.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card variant="bordered" id="ip-rights">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">13.1 CloudSave Intellectual Property</h3>
                    <p>CloudSave and its licensors retain all rights, title, and interest in the Services and all software, technology, and infrastructure, the CloudSave name, logo, and branding, all patents, trademarks, copyrights, and trade secrets, and all improvements, modifications, and derivative works.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>You retain all ownership rights in your User Content. CloudSave does not claim ownership of any User Content you upload or store.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">14.2 License to CloudSave</h3>
                    <p>By uploading User Content, you grant CloudSave a limited license to store, process, and transmit your Content (necessary to provide the Services), create backups and redundant copies, display Content to users you authorize, and use technical measures to protect your Content.</p>
                  ...
                  <div>
                    ...
                    <p>For Content you make available through Channels, you grant CloudSave a license to display, distribute, and make the Content available to users who unlock your Channel, and users who unlock your Channel a limited license to view the Content for personal use.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>CloudSave respects the intellectual property rights of others and expects users to do the same. We respond to notices of alleged copyright infringement in accordance with applicable law.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>For copyright claims outside the United States, please contact dmca@cloudsave.org with equivalent information under your local law.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>Support is available through email at support@cloudsave.org, in-app help center, and online documentation. Response times vary based on issue severity and support volume.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>You may terminate your account at any time through account settings in the application or by contacting support@cloudsave.org. Upon termination, your right to access the Services ends immediately, you may download your data before termination (encrypted files require your password), and subscription fees are not refunded for partial periods (except as required by law).</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">20.2 Termination by CloudSave</h3>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-muted/50">
                    ...
                    <p className="uppercase text-sm">TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, CLOUDSAVE AND ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AFFILIATES, AND LICENSORS SHALL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, LOSS OF PROFITS, REVENUE, OR DATA, BUSINESS INTERRUPTION, OR COST OF SUBSTITUTE SERVICES, REGARDLESS OF THE THEORY OF LIABILITY.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">22.2 Liability Cap</h3>
                    <p className="uppercase text-sm">TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, OUR TOTAL CUMULATIVE LIABILITY FOR ALL CLAIMS ARISING FROM OR RELATED TO THESE TERMS OR THE SERVICES SHALL NOT EXCEED THE GREATER OF: THE AMOUNT YOU PAID TO CLOUDSAVE IN THE 12 MONTHS PRECEDING THE CLAIM; OR ONE HUNDRED US DOLLARS ($100 USD).</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="uppercase text-sm">THE LIMITATIONS OF LIABILITY IN THESE TERMS ARE A FUNDAMENTAL ELEMENT OF THE BASIS OF THE BARGAIN BETWEEN YOU AND CLOUDSAVE. THE SERVICES WOULD NOT BE PROVIDED WITHOUT SUCH LIMITATIONS.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>To the maximum extent permitted by applicable law, you agree to defend, indemnify, and hold harmless CloudSave, its parent company, affiliates, licensors, service providers, and their respective officers, directors, employees, and agents from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys&apos; fees) arising out of or relating to your violation of these Terms, your User Content, your use of the Services, your violation of any third party&apos;s rights, and your violation of any applicable law.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>This indemnification obligation does not apply to the extent that a claim arises from CloudSave&apos;s gross negligence or willful misconduct. Some jurisdictions do not allow indemnification provisions; in such jurisdictions, this section applies to the maximum extent permitted by law.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="text-muted-foreground space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-2 p-3 rounded-lg bg-muted/50">
                      ...
                      <p>As required under Indian law, our Grievance Officer can be contacted at: grievance@cloudsave.org</p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p>If you are in a jurisdiction with consumer protection laws that provide rights beyond those in these Terms, your statutory rights are not affected. In case of conflict, mandatory local law prevails. Please contact legal@cloudsave.org with questions about your jurisdiction.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>Before initiating formal dispute resolution, you agree to contact us at disputes@cloudsave.org and attempt to resolve the dispute informally for at least 30 days.</p>
                  </div>
                  <div>
                    ...
                    <p className="uppercase text-sm">YOU AND CLOUDSAVE AGREE THAT DISPUTES WILL BE RESOLVED ONLY ON AN INDIVIDUAL BASIS AND NOT IN A CLASS, CONSOLIDATED, OR REPRESENTATIVE ACTION.</p>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>These Terms, together with our <NextLink href="/privacy-policy" className="gradient-link">Privacy Policy</NextLink> and any Additional Terms, constitute the entire agreement between you and CloudSave regarding the Services and supersede all prior agreements and understandings.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>Notices to you may be sent to your registered email address or posted within the application. Notices to CloudSave must be sent to legal@cloudsave.org.</p>
                  </div>
                  <div>
            ...
            <Card variant="bordered" id="contact">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-muted/50">
                    <h3 className="font-semibold text-foreground mb-2">CloudSave Legal Team</h3>
                    <p>AXSA Technologies Private Limited</p>
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-2">
                      <p>General Support: support@cloudsave.org</p>
                      <p>Legal Inquiries: legal@cloudsave.org</p>
                      <p>Billing Issues: billing@cloudsave.org</p>
                      <p>Abuse Reports: abuse@cloudsave.org</p>
                      <p>DMCA/Copyright: dmca@cloudsave.org</p>
                      <p>Disputes: disputes@cloudsave.org</p>
                      <p>Privacy: privacy@cloudsave.org</p>
                      <p>Grievance Officer (India): grievance@cloudsave.org</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="text-center text-sm text-muted-foreground pt-8 border-t border-border">
              ...
              <p className="mt-2">By using CloudSave, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.</p>
            </div>
          </motion.div>
        </div>
      </section>
