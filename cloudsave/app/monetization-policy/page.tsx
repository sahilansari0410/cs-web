        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              Addendum to <Link href="/terms" className="gradient-link">Terms of Service</Link>. These terms govern your participation in the CloudSave Channel system and Monetization Program.
            </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Retain ownership of everything you upload. Grant CloudSave a license to display it.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">You are an independent contractor, not a CloudSave employee.</p>
                    </div>
                  </div>
                </div>
          ...
          >
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>These Channel and Monetization Terms (&quot;Creator Terms&quot;) govern your participation in the CloudSave Channel system and Monetization Program. They establish the rules for creating Channels, publishing content, and earning revenue through the platform.</p>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>Creates a Channel on CloudSave</li>
                  ...
                  <div>
                    ...
                    <p>These Creator Terms are an addendum to and incorporated into the main CloudSave <Link href="/terms" className="gradient-link">Terms of Service</Link>. By creating a Channel or applying for monetization, you agree to both documents.</p>
            ...
            <Card variant="bordered" id="definitions">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-3">
                  ...
                  <p><strong className="text-foreground">&quot;Creator Dashboard&quot;</strong> means the section of the CloudSave application where you manage your Channel(s) and view monetization metrics.</p>
                  <p><strong className="text-foreground">&quot;Monetization Program&quot;</strong> means CloudSave&apos;s revenue-sharing program for eligible Creators.</p>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>Any eligible CloudSave user may create a Channel, subject to account in good standing, compliance with these Creator Terms, and completion of required profile information.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>You may create multiple Channels, subject to each Channel having distinct content or purpose, no use of multiple Channels to circumvent platform rules, and CloudSave&apos;s right to limit the number of Channels per account.</p>
                  </div>
                  <div className="p-4 rounded-xl bg-warning/10 border border-warning/20">
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>Publicly visible to all CloudSave users</li>
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      ...
                      <li>You must provide consent documentation upon CloudSave&apos;s request</li>
                    </ul>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>If your Channel includes third-party content (music, images, clips, etc.), you must have proper licenses or permissions, comply with the terms of any licenses, are responsible for any licensing fees, and CloudSave may remove content upon copyright claims.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-success/10 border border-success/20">
                    ...
                    <p>You retain full ownership of all Channel Content you create and upload. <strong className="text-foreground">CloudSave does not claim ownership of your content.</strong></p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">5.2 License Grant to CloudSave</h3>
                    <p>By uploading Channel Content, you grant CloudSave a:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                  ...
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
                    ...
                    <p className="mt-2">CloudSave does not restrict your ability to distribute your content elsewhere.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">5.6 Content After Termination</h3>
                    <p>Upon termination of your account or Channel, you may download your content before termination takes effect, CloudSave&apos;s license to your content terminates (subject to Section 5.3), existing subscriber access windows will complete naturally, and we may retain content as required for legal compliance.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
                    ...
                    <p className="mt-3">You acknowledge that this mechanism is fundamental to the CloudSave ecosystem, cannot be disabled or modified by Creators, applies equally to all Channels, and is designed to create ongoing engagement and fair revenue distribution.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>Cloud Coin costs for unlocks are set by CloudSave based on platform economics, uniform across similar Channel categories, subject to change with notice to Creators, and displayed to subscribers before unlock.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>The Monetization Program allows eligible Creators to earn revenue from subscriber activity on their Channels. Participation is a privilege granted at CloudSave&apos;s discretion, not a right.</p>
                  </div>
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                      ...
                      <div className="p-4 rounded-xl bg-muted/50">
                        ...
                        <ul className="list-disc pl-6 space-y-1 text-sm">
                          ...
                          <li>Manual application via support@cloudsave.org</li>
                          <li>Approval at CloudSave&apos;s sole discretion</li>
                          <li>Completed tax and payment information</li>
                        </ul>
                      </div>
                    </div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
                    ...
                    <p>CloudSave uses the &quot;15-Unlock Rule&quot; to calculate Creator revenue:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                  ...
                  <div>
                    ...
                    <p>The RPAS rate is variable and determined by CloudSave, reflects ad market conditions, platform costs, and sustainability, may differ by region or category, is displayed on your Creator Dashboard, and is subject to change (see Section 15).</p>
                    <p className="mt-2">Current rates are always available at: https://cloudsave.org/creator-rates</p>
                  </div>
                  <div className="p-4 rounded-xl bg-success/10 border border-success/20">
                    ...
                    <div className="flex gap-4 mt-2">
                      ...
                      <div className="flex-1 text-center p-3 rounded-lg bg-background">
                        ...
                        <p className="text-sm">CloudSave</p>
                      </div>
                    </div>
                    <p className="mt-3 text-sm">Creators keep 100% of their earnings. CloudSave covers platform infrastructure, payment processing, support, and marketing costs.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="mt-2">CloudSave&apos;s records are the authoritative source for all revenue calculations. You may request clarification through support@cloudsave.org.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>Earnings are calculated in USD. Payouts are converted to your local currency at prevailing exchange rates determined at the time of payout processing. CloudSave does not guarantee specific exchange rates.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">9.5 Payment Fees</h3>
                    <p>CloudSave covers standard payment processing fees. International wire transfer fees exceeding $15 USD may be deducted. Currency conversion spreads are included in the exchange rate. Your bank may charge receiving fees (your responsibility).</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>If you believe a payment is incorrect, contact support@cloudsave.org within 60 days, provide specific details of the discrepancy, and we will investigate and respond within 14 business days. Adjustments, if warranted, will be applied to subsequent payouts.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-warning/10 border border-warning/20">
                    ...
                    <p className="mt-2 text-sm"><strong>CloudSave does not provide tax advice. Consult a qualified tax professional.</strong></p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>CloudSave may withhold taxes as required by law:</p>
                  ...
                  <div>
                    ...
                    <p>CloudSave provides annual earnings statements, TDS certificates (India), 1099-MISC or 1099-NEC (US, where applicable), and other reports as required by law. You can access tax documents in your Creator Dashboard.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>You grant CloudSave the right to feature your Channel in platform recommendations, include your content in &quot;trending&quot; or &quot;featured&quot; sections, use your Channel name and thumbnail in platform marketing, and create promotional previews of your content.</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p>You may promote your CloudSave Channel on your own social media and websites, using CloudSave branding according to our brand guidelines, and with accurate representation of the platform and your content.</p>
                    <p className="mt-2">You may not make false claims about earnings or platform features, imply official endorsement by CloudSave, or use promotional tactics that violate platform rules.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>You agree to maintain accurate account and payment information, respond to CloudSave communications within 14 days, comply with content and conduct guidelines, report any unauthorized access to your account, and cooperate with investigations into potential violations.</p>
                  </div>
                  <div>
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      ...
                      <li>Harass CloudSave staff or other creators</li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>Email: abuse@cloudsave.org</li>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>CloudSave monitors for fraudulent activity, including unusual unlock patterns, bot or automated activity, coordinated inauthentic behavior, geographic or temporal anomalies, and payment fraud indicators.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>CloudSave may modify these Creator Terms, including eligibility requirements, revenue calculation methods, payment terms and thresholds, and RPAS rates.</p>
                  </div>
                  <div>
            ...
            <Card variant="bordered" id="suspension">
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">16.1 Suspension by CloudSave</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">16.2 Termination by CloudSave</h3>
                  ...
                  <div>
                    ...
                    <p>You may terminate your participation at any time through Creator Dashboard settings or by emailing support@cloudsave.org. Effective upon confirmation.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>To appeal:</p>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>Email: appeals@cloudsave.org</li>
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <ul className="list-disc pl-6 space-y-1">
                      ...
                      <li>Your content licenses to CloudSave terminate (subject to wind-down period)</li>
                      <li>You may continue using CloudSave as a regular user</li>
                    </ul>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>You have no authority to enter into contracts on behalf of CloudSave, make representations or warranties for CloudSave, or bind CloudSave to any obligations.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div className="p-4 rounded-xl bg-muted/50">
                    ...
                    <p className="uppercase text-sm">TO THE MAXIMUM EXTENT PERMITTED BY LAW, CLOUDSAVE&apos;S LIABILITY FOR MONETIZATION-RELATED CLAIMS IS LIMITED TO THE AMOUNT OF UNPAID EARNINGS IN YOUR ACCOUNT AT THE TIME OF THE CLAIM.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">20.2 Exclusions</h3>
                    <p className="uppercase text-sm">CLOUDSAVE IS NOT LIABLE FOR LOST PROFITS OR ANTICIPATED EARNINGS, INDIRECT, CONSEQUENTIAL, OR PUNITIVE DAMAGES, DAMAGES FROM ALGORITHM OR RATE CHANGES, THIRD-PARTY CLAIMS AGAINST YOU, OR LOSSES FROM YOUR VIOLATION OF THESE TERMS.</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">20.3 Exceptions</h3>
                    <p>These limitations do not apply to CloudSave&apos;s gross negligence or willful misconduct, amounts owed for legitimate earned revenue, or liabilities that cannot be limited by law.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  <div>
                    ...
                    <p>You agree to indemnify and hold harmless CloudSave from claims arising from your Channel Content, your violation of these Creator Terms, your violation of any third party&apos;s rights, your tax obligations, and your representations to subscribers.</p>
                  </div>
                  <div>
              ...
              <CardContent className="p-6 md:p-8">
                ...
                <div className="text-muted-foreground space-y-4">
                  ...
                  <div>
                    ...
                    <p>You may not assign your participation in the Monetization Program. CloudSave may assign these terms in connection with a business transfer.</p>
                  </div>
                  <div>
