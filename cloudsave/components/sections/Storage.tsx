            ...
            <Card variant="bordered" className="h-full bg-success/5 border-success/20">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  We don&apos;t restrict file types. Upload any file regardless of extension - photos, videos, documents, archives, project files, or anything else. If your device can create it, CloudSave can store it.
                </p>
            ...
            <Card variant="bordered">
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="font-semibold text-foreground">CloudSave vs. Others</h3>
                </div>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border">
                        ...
                        <th className="text-center py-3 px-4 text-sm font-medium text-primary">CloudSave</th>
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl bg-card border border-border">
            ...
            <span className="text-foreground">
              Others charge per GB or TB. <span className="font-semibold">CloudSave doesn&apos;t.</span>
            </span>
          </div>
        </motion.div>
      </div>
