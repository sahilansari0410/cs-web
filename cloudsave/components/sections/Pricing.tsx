    ...
    <section id="pricing" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card variant="bordered" className="h-full">
              <CardContent className="p-6 h-full">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-semibold text-foreground">The CloudSave Advantage</h3>
                </div>
          ...
          {/* CloudSave Difference - Bento Card */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            ...
            <Card variant="bordered" className="h-full bg-success/5 border-success/20">
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-semibold text-foreground">CloudSave Difference</h3>
                </div>
                <p className="text-sm text-muted-foreground mb-4">
            ...
            <Card variant="bordered">
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="font-semibold text-foreground">CloudSave vs. The Rest</h3>
                </div>
